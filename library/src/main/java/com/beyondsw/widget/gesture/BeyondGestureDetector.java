 ...
 * To use this class:
 * <ul>
 * <li>Create an instance of the {@code BeyondGestureDetector} for your {@link android.view.View}
 ...
 * in {@link android.view.View#onGenericMotionEvent(MotionEvent)}.
 * </ul>
 */
public class BeyondGestureDetector {
    /**
    ...
    private float mScrollSensitivity = 1;
    ...
    /**
     * Creates a BeyondGestureDetector with the supplied listener.
     ...
     */
    @Deprecated
    public BeyondGestureDetector(OnGestureListener listener, Handler handler) {
     ...
     */
    @Deprecated
    public BeyondGestureDetector(OnGestureListener listener) {
     ...
     * @see android.os.Handler#Handler()
     */
    public BeyondGestureDetector(Context context, OnGestureListener listener) {
        this(context, listener, null);
    }

    /**
     * Creates a BeyondGestureDetector with the supplied listener that runs deferred events on the
     ...
     * @see android.os.Handler#Handler()
     */
    public BeyondGestureDetector(Context context, OnGestureListener listener, Handler handler) {
        if (handler != null) {
    ...
    private void init(Context context) {
        ...
        if (context == null) {
            ...
            doubleTapTouchSlop = getScaledDoubleTapTouchSlop(configuration);
    ...
    public void setScrollSlop(int s) {
        mTouchSlopSquare = s;
    }

    private int getScaledDoubleTapTouchSlop(ViewConfiguration cf) {
        try {
            Method m = ViewConfiguration.class.getDeclaredMethod("getScaledDoubleTapTouchSlop");
            if (m != null) {
                Integer value = (Integer) m.invoke(cf);
                return value == null ? DOUBLE_TAP_SLOP : value;
            }
